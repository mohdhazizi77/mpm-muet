...
var chartPieBasicColors = getChartColorsArray("simple_pie_chart_muet");
if (chartPieBasicColors) {
    ...
    var chart = new ApexCharts(document.querySelector("#simple_pie_chart_muet"), options);
    chart.render();
}

var chartPieBasicColors = getChartColorsArray("simple_pie_chart_mod");
if (chartPieBasicColors) {
    var options = {
        series: [1000, 200],
        chart: {
    ...
    var chart = new ApexCharts(document.querySelector("#simple_pie_chart_mod"), options);
    chart.render();
}
