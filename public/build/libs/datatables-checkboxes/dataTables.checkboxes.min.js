...
!function (c) {
    ...
    x.prototype = {
        _constructor: function () {
            ...
            (e.oFeatures.bServerSide || e.oFeatures.bDeferRender) && c.updateStateCheckboxes({page: "current", search: "none"}), k.each(c.s.columns, function (e, t) {
                c.updateSelectAll(t)
            })
            ...
            var s = this, t = s.s.dt, o = s.s.ctx, l = k(c).closest("td"), a = l.parents(".DTFC_Cloned").length ? t.fixedColumns().cellIndex(l) : l, n = t.cell(a), d = n.index().column;
            ...
            if (e.aanFeatures.i) {
                ...
                if (null !== t) {
                    ...
                    k.each(e.aanFeatures.i, function (e, t) {
                        ...
                        c = "rekod", s = d, l.append(k('<span class="select-item"/>').append(n.i18n("select." + c + "s", {_: "%d " + c + " dipilih", 0: "", 1: "1 " + c + " dipilih"}, s)));
