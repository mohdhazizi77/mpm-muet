                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 pt-4 mb-4">
                            ...
                            <div class="mb-5">
                                <h1 class="display-2 coming-soon-text">Under maintenance</h1>
                            </div>
                            <div>
                                ...
                                <div class="mt-5">
                                    <h3>MUET Online Certificate System is now closed for maintenance.</h3>
                                    <p class="text-muted">System will be up online on 2nd October 2024 at 3 p.m., Thank you 😊</p>
                                </div>
