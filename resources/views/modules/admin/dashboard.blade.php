...
@section('content')
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" id="muetNew-count" data-target="1234">0</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate bg-warning bg-opacity-50">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="1234">100</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate bg-secondary">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">6000</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate bg-warning bg-opacity-50">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="1234">50</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate bg-secondary">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">360</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
    ...
    <div class="row">
        ...
        <div class="col-xl-2 col-md-6">
            <!-- card -->
            <div class="card card-animate" style="background-color: #7d4daa">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">RM 10,000.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate" style="background-color: #f86624">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">RM 5,000.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate" style="background-color: #68d4cd">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">RM 15,000.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate" style="background-color: #7d4daa">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">RM 1,000.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
            ...
            <div class="card card-animate" style="background-color: #f86624">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">RM 200.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-animate" style="background-color: #cff67b">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="text-uppercase fw-semibold mb-0">TOTAL COLLECTION (RM)</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">
                                <span class="counter-value" data-target="6000">1,200.00</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
    ...
    <div class="row">
        ...
        {{--            <div class="card">--}}
        {{--                <div class="card-header">--}}
        {{--                    <h4 class="card-title mb-0">Total Collection, Year 2024</h4>--}}
        {{--                </div><!-- end card header -->--}}
