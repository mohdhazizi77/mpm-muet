        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="horizontal-logo">
                    ...
                    {{--                        </span>--}}
                    {{--                    </a>--}}
                    {{--                    <a href="index" class="logo logo-dark px-2">--}}
                    {{--                        <span class="logo-sm">--}}
                    {{--                            <img src="{{ URL::asset('build/images/muet-text-long-white.png') }}" alt="" height="55">--}}
                    {{--                        </span>--}}
                    {{--                        <span class="logo-lg">--}}
                    {{--                            <img src="{{ URL::asset('build/images/muet-text-long-white.png') }}" alt="" height="55">--}}
                    {{--                        </span>--}}
                    ...
                    <a href="/candidate" class="logo logo-light mx-2">
                        ...
                        <span class="logo-lg">
                            <img src="{{ URL::asset('build/images/muet-online-certificate.png') }}" alt="" height="65">
                        </span>
                    </a>
