                    ...
                    <div class="row">
                        <div class="col-xxl-12 align-self-center">
                            <div class="float-end my-3">
                                <button type="button" class="btn btn-soft-success waves-effect float-end mx-1">PRINT CERTIFICATE</button>
                                <button type="button" class="btn btn-soft-secondary waves-effect float-end ">EXPORT POS XLSX</button>
                            </div>
