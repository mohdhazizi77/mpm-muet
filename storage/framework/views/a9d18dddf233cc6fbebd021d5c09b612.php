                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input disabled value="pos12345" type="text" class="form-control" placeholder="Enter tracking number" id="tn">
                                                                    </div>
                                                                </div><!--end col-->
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input disabled value="" type="text" class="form-control" placeholder="" id="tn">
                                                                    </div>
                                                                </div><!--end col-->
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/datatables/pos-completed.js')); ?>"></script>

<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master-mpm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi-3TDS\Desktop\CODE\mpm-muet\resources\views/admin/pos/completed/index.blade.php ENDPATH**/ ?>