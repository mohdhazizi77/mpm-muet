                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group" data-input-flag>
                                                    <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="<?php echo e(URL::asset('build/images/flags/my.svg')); ?>" alt="flag img" height="20"
...
<?php endif; ?>
            ...
            <a id="button-payment" href="<?php echo e(route('candidates.payment')); ?>" class="btn btn-soft-success btn-label btn-border waves-effect waves-light w-lg float-end">
...
<?php echo $__env->make('layouts.master-candidate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi-3TDS\Desktop\CODE\mpm-muet\resources\views/candidates/print-mpm.blade.php ENDPATH**/ ?>