                        ...
                        <div class="text-center mt-sm-3 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <img src="<?php echo e(URL::asset('build/images/mpm-logo.png')); ?>" alt="" height="100">
                                </a>
                            </div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('build/images/muet-text-long-black.png')); ?>" alt="" height="60">
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form action="<?php echo e(route('candidate.login')); ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input onkeyup="populatePassword()" id="username" name="username" type="text" value="<?php echo e(old('username')); ?>" placeholder="Enter identification card number or passport"
